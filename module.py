...
class Darknet53(torch.nn.Module):
    ...
    def __init__(self):
        ...
        self.trunk_52 = torch.nn.Sequential(
            ...
            ConvolutionalLayer(32, 64, 3, 2, 1),#150

            ResidualLayer(64),
            ConvolutionalLayer(64, 128, 3, 2, 6),  # 80
            ResidualLayer(128),
            ResidualLayer(128),
            DownsamplingLayer(128, 256),#40
            ResidualLayer(256),
            ResidualLayer(256),
            ResidualLayer(256),
            ResidualLayer(256),
